// RTl & Ltr
$('<ul class="custom-theme"><li class="demo-li"><a href="../index.html" target="_blank">Front end</a></li><li class="btn-rtl">RTL</li><li class="btn-dark-setting">Dark</li></ul>').appendTo($('body'));
(function () {
})();
//live customizer js
